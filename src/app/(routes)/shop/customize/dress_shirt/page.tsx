...
import img1 from "../../../../../../public/dress_shirt_white_full.webp";
import img2 from "../../../../../../public/dress_shirt_white_half.webp";
import img5 from "../../../../../../public/dress_shirt_blue_full.webp";
import img6 from "../../../../../../public/dress_shirt_blue_half.webp";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
    ...
    <SheetHeader>
     ...
     <AlertDialog>
            ...
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                <button
                  className="flex gap-4 justify-center text-black w-full items-center p-4 hover:bg-yellow-100"
                  onClick={() =>
                    color == "white" ? setImage(img1) : setImage(img5)
                  }
                >
                  <Shirt size={50} />
        ...
        {/* <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Pocket Type</AlertDialogTitle>
              <AlertDialogDescription>
                <button
                  className="flex gap-4 justify-center text-black w-full items-center p-4 hover:bg-yellow-100"
                  onClick={() =>
                    color == "white" ? setImage(img4) : setImage(img6)
                  }
                >
                  <Shirt size={50} />
                  <span>Short Sleeve</span>
                ...
                <button
                  className="flex gap-4 justify-center text-black w-full items-center p-4 hover:bg-yellow-100"
                  onClick={() =>
                    color == "white" ? setImage(img3) : setImage(img5)
                  }
                >
                  <Shirt size={50} />
                  <span>Long Sleeve</span>
  ...
  <DrawerContent>
    <DrawerHeader>
      ...
      <DrawerDescription className="flex flex-col justify-center items-center gap-4">
        <p className="text-center">Answer a few questions and have your measurements ready in no time.</p>
        <form className="flex flex-col gap-1">
            <h3 className="text-xl font-bold  text-center">Enter You Age</h3>
            <input type="text" className="border-2 border-black p-5" placeholder="Enter You Age"/>
            <h3 className="text-xl font-bold  text-center">Enter You Body Height</h3>
            <input type="text" className="border-2 border-black p-5" placeholder="Enter You Body Height"/>
            <h3 className="text-xl font-bold  text-center">Enter You Weight</h3>
            <input type="text" className="border-2 border-black p-5" placeholder="Enter You Weight"/>
